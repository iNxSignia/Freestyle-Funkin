...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Stop rapping', 0.2], //From 0% to 19%
		['Dogshit', 0.4], //From 20% to 39%
		['Trash', 0.5], //From 40% to 49%
		['Soundcloud rapper lol', 0.6], //From 50% to 59%
		['Needs work', 0.69], //From 60% to 68%
		['It got potential', 0.7], //69%
		['Ight', 0.8], //From 70% to 79%
		['Nice bars', 0.9], //From 80% to 89%
		['Shit fye, props due', 1], //From 90% to 99%
		['Straight gas', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case "winter-horrorland":
					...
					case 'cardiak':
						//if(daSong == 'cardiak') FlxG.sound.play(Paths.sound('ANGRY'));
